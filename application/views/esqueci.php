...
<head>
<meta charset="utf-8"/>
<title><?php echo config_site('nome_site');?> - Esqueci minha senha</title>
...
<div class="content">
    ...
    <form class="forget-form" action="" method="post" style="display:block;">
        ...
        <div class="form-actions">
            <button type="button" id="back-btn" class="btn btn-default" onclick="window.location.href='<?php echo base_url();?>login'">Voltar</button>
