        ...
        <div class="page-header">
            ...
            <div class="page-header-top">
                <div class="container">
                    <!-- BEGIN LOGO -->
                    <div class="page-logo">
                        <a  href="<?php echo site_url('ctadmin'); ?>"><img style="width: 172px; margin: -20px 0 0 0;" src="<?php echo base_url('uploads/' . config_site('imagem_logo_admin')); ?>" alt="logo" class="logo-default"></a>
                    </div>
                    <!-- END LOGO -->
