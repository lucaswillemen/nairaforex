...
<div class="page-content">
    <div class="container">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('ctadmin/pacotes'); ?>">Adicionar Pacote</a>
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="form-body">
                                                            ...
                                                            <div class='form-group'>
                                                                ...
                                                                <input type='text' name='nivel' class='form-control' value='' required="">
                                                            </div>
                                                            <?php
                                                            for ($i = 1; $i <= 14; $i++) {
                                                                echo "   <div class='form-group'>
                                                                <label>Nível {$i}: </label>
                                                                <input type='text' name='nivel{$i}' class='form-control' value=''>
                                                            </div>";
                                                            }
                                                            ?>
                                                        </div>
