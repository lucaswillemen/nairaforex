...
<style type="text/css">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <a href="<?php echo base_url('inativo/faturas'); ?>" style="width: 31%;">
                                            <img src="<?php echo base_url('uploads/' . config_site('imagem_logo_admin')); ?>" alt="<?php echo config_site('nome_site'); ?>" class="logo-default" style="width: 200%;margin: 0px 10px 0 60px;" />
                    </a>
