                                ...
                                <div class="form-body">
                                    ...
                                    if ($informacao !== false) {
                                        ...
                                        <p>
                                            ...
                                            <b>Valor da Fatura:</b> $ <?php echo number_format($pacote->valor, 2); ?> USD<br />
                                            <?php
                                            if (config_site('taxa_pagamento_saldo') > 0) {
                                                echo '<b>Taxa: </b>$ ' . config_site('taxa_pagamento_saldo') . ' USD <br />';
                                            }
                                            ?>
                                            <b>Total a pagar: </b> $ <?php echo number_format(($pacote->valor) + config_site('taxa_pagamento_saldo'), 2); ?> USD
