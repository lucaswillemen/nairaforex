            ...
            <div class="page-header-inner">
                ...
                <div class="page-logo">
                    <a href="<?php echo base_url('conta'); ?>">
                        <img src="<?php echo base_url('uploads/' . config_site('imagem_logo_admin')); ?>" alt="<?php echo config_site('nome_site'); ?>" class="logo-default"/>
                    </a>
                    ...
                    <ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li>
                            <a href="<?php echo base_url('cotas'); ?>">
                                ...
                                <span class="title">Meus Pacotes</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('cotas/comprar'); ?>">
                                <i class="fa fa-credit-card"></i>
                                <span class="title">Comprar Pacotes</span>
                            </a>
                        </li>
                        <li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo base_url('extrato'); ?>">
                                ...
                                <span class="title">Extrato de Ganhos</span>
                            </a>
                        </li>

                        <?php if (config_site('permitir_transferencia_membros') == 1) { ?>
                            <li>
                                <a href="<?php echo base_url('transferir'); ?>">
                                    <i class="fa fa-arrow-right"></i>
                                    <span class="title">Transferencia de Saldo</span>
                                </a>
                            </li>
                        <?php } ?>

                        <li>
                            <a href="<?php echo base_url('pagar/saldo'); ?>">
                                <i class="fa fa-magic"></i>
                                <span class="title">Ativar usuários</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo base_url('indicados'); ?>">
                                ...
                                <span class="title">Minha Rede</span>
                        ...
                        <li>
                            <a href="<?php echo base_url('conta/graduacoes'); ?>">
                                <i class="fa fa-graduation-cap"></i>
                                <span class="title">Graduações</span>
                                <span class="arrow "></span>
