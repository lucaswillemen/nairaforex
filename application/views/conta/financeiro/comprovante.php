                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select name="id_fatura" class="form-control" required>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $fatura->id;?>">Fatura #<?php echo $fatura->id;?> - Compra de <?php echo $fatura->quantidade_cotas;?> cotas por $ <?php echo number_format($fatura->quantidade_cotas * config_site('valor_cota'), 2);?> USD</option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
