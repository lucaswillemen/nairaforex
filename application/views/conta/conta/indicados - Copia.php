...
<div class="portlet light">
                ...
                <tbody>
                    ...
                    if ($indicados !== false) {
                        ...
                        foreach ($indicados as $indicado) {
                            ...
                            <tr>
                                <td>
                                    <?php echo $indicado->nome; ?>(<?php echo $indicado->login; ?>)-<?= $indicado->id ?>
                                </td>
                                <td>
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(1)
            </div>
            <div class="tools">
            </div>
        </div>
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(2)
            </div>
            <div class="tools">
            </div>
        </div>
...
//1
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(3)
            </div>
            <div class="tools">
            </div>
        </div>
        <div class="portlet-body">
            <table  class="tableIndicados table table-striped table-bordered table-hover" id="sample_6">
                ...
                <tbody>
                    <?php
                    if ($indicadosMaster !== false) {
                        foreach ($indicadosMaster as $indicado) {
//1
                            $indicados = $conta_model->Indicados($indicado->id);
                            if ($indicados !== false) {
                                foreach ($indicados as $indicado) {
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(4)
            </div>
            <div class="tools">
            </div>
        </div>
...
//1
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(5)
            </div>
            <div class="tools">
            </div>
        </div>
...
//1
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(6)
            </div>
            <div class="tools">
            </div>
        </div>
...
//1
    ...
    <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i> Indicados indiretos(7)
            </div>
            <div class="tools">
            </div>
        </div>
