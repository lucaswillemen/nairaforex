...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="<?php echo base_url('cotas/comprar'); ?>">Comprar cotas</a>
    </li>
</ul>
<!-- END PAGE HEADER-->
<div class="clearfix">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-money"></i>Compre quantas cotas quiser
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    if (!$this->input->post('submit')) {
                                            ...
                                            <select name="quantidade" class="bs-select form-control" required="">
                                                ...
                                                if ($query->num_rows > 0) {
                                                    foreach ($query->result() as $row) {
                                                        ...
                                                        echo "<option value='{$row->cotas_qnt}'>{$row->nome} - {$row->cotas_qnt} cota(a) - {$valor}</option>";
                                                    }
                                                }
                                                ?>  
                                            </select>
                        ...
                        <div class="form-body">
                            ...
                            ?>
                            <p>Parabéns, você efetuou a compra de <?php echo $quantidade; ?> cota(s) em nosso site. Segue abaixo a compra detalhada:</p>
